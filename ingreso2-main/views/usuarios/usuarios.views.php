...
<style>
  ...
  top: 0;
  left: 0;
  z-index: 0; /* Asegúrate de que el canvas esté por encima del video */
}
        ...
        <div class="modal-content">
            ...
            <form id="form_usuarios" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group" id = "video_p">
                        <label for="Video">Foto para el reconocimiento facial</label>
                        <label for="Video"></label>
                        <label for="Video"></label>
                        <video id= "video" width="300" height="300" autoplay style="position: absolute;"></video>
                      
                    <!-- <canvas width="300" height="300" autoplay class="js-canvas"></canvas><br> -->
                    

                    </div>

                </div>
                <div class="modal-footer" id = "div_video">
...
<script src= "../../public/assets/js/face-api.js"></script>
